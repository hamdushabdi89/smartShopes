    ...
    <header className="glass-strong px-6 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-5">
        <button className="relative p-2 rounded-xl hover:bg-[rgba(255,255,255,0.04)] transition-colors">
          ...
          <span className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#d4af37] text-[10px] font-bold text-black flex items-center justify-center">3</span>
        </button>
        ...
        <div className="flex items-center gap-3 pl-5 border-l border-[rgba(212,175,55,0.1)]">
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-medium text-[#f5f5f5]">Alex D.</p>
            <p className="text-[11px] text-[#a0a0a0]">Admin</p>
          </div>
